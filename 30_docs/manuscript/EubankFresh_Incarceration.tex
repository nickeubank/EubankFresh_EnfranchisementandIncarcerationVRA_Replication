...
% %-------------------------------------------
 \begin{figure}[h!]
 	\begin{center}
 	\caption{Trends in Black prison admissions rates by state (with imputations, continued)}
 	\small
...
\end{figure} \normalsize
 ...
 \begin{figure}[h!]
 	\begin{center}
 	\caption{Trends in difference between Black and White prison admissions rates by state (with imputations, continued)}
 	\small
...
We also consider data from \citesec{ANES:2020ut}.  This data lacks the detail of other data (see Blumenthal et. al. below) and the pre-1965 time frame as other data (see above).  But it does give us some information about change over time for a consistent question measured as early as 1966.  The survey is fielded on US adults and the sample size varies slightly by year.  There were 1,257 respondents in our 1966 sample.
 ...
 \begin{figure}[h!]
   	...
   	\caption{Police feeling thermometer responses from the ANES, 1966-1992}
   		...
   		\smallskip
			(a) Averages by race \\
   			\includegraphics[width=4.2in,  clip=true,  trim= 0.0in 0.0in 0.0in 0.0in]{../../50_results/Attitudes_violence1969_2.pdf} \\
				\smallskip \smallskip
				(b) Differences in means between Black and White respondents \\
   			\includegraphics[width=4.2in,  clip=true,  trim= 0.0in 0.0in 0.0in 0.0in]{../../50_results/Attitudes_violence1969_3.pdf}\\
   		\label{figure_anes}
   		\end{center}
