...
// 	do $NewJimCrow/10_code/50_analysis/25_state_sample_MI_summarystats.do
	...
	do $NewJimCrow/10_code/50_analysis/30_cty_main_effects_MI_fgls.do
	do $NewJimCrow/10_code/50_analysis/31_cty_main_effects_MI_ols.do
	do $NewJimCrow/10_code/50_analysis/35_county_plots.do
	do $NewJimCrow/10_code/50_analysis/40_cty_heterogeneous_effects_MI_fgls.do
	do $NewJimCrow/10_code/50_analysis/41_cty_heterogeneous_effects_MI_ols.do
	do $NewJimCrow/10_code/50_analysis/43_cty_heterogeneous_effects_by_beo_MI_fgls.do
