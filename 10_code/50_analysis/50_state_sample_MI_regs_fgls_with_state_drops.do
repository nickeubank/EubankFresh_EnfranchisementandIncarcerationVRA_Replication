...
forvalues x = 1/2 {
    ...
    * Load data and label for esttab
    ...
    label var vra2_x_post1965_x_year		"Post-1965 $\times$ Covered $\times$ \emph{T}"
	...
	esttab
		...
		using $NewJimCrow/50_results/table_threefold_diff_`panel'_MI_fgls_drop`state'.tex,
